...
public class MatrixInitializer {
     ...
     *
     *         Ответ: в getValue(), при вычислении left использовался индекс i + 1 в строке matrix[i][j - 1],
     *         что приводило к выходу за приделы масива. Индекс i должен оставаться таким же,
     *         изменяется только j
     *
